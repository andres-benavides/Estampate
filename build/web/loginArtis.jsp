    ...
    <nav class="navbar navbar-default">
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" >
          <button type="button" class="btn btn-default navbar-btn" id="btnSession">Iniciar Sesion</button>
          <button type="button" class="btn btn-default navbar-btn btn-registro" >Registrarse</button>
        ...
        <div class="col-lg-6 col-ms-6 col-xs-6">
          <form class="form-horizontal" action="guardarRegistro" method="post" role="form"  >
            ...
            <div class="form-group">
              ...
              <div class="col-lg-7">
                <input type="number" name="cedula" id="cedula" class="form-control" required required min="1" max="9999999999" />
              </div>
            </div>
            <div class="form-group">
              <label class="col-lg-2 control-label"  for="celular">Celular:</label>
              <div class="col-lg-7">
                <input type="number" name="celular" id="celular" class="form-control" required required min="1" max="9999999999" />
              </div>
            </div>
            <div class="form-group">
